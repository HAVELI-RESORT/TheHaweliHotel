        ...
        <>
            <div className='w-full h-full bg-yellow-100 bg-opacity-50 mb-[10px]'>
                ...
                <div className="container mx-auto mt-[72px] ml-[2rem]">
                    ...
                    <p>By accessing this website, we assume you accept these terms of service in full. Do not continue to
                        use THE HAWELI RESORT&#x27;s website if you do not accept all of the terms and conditions stated on
                        this page.</p>
